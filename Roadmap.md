...
**Продакшен:** [snakeattack.ru](https://snakeattack.ru/)
...
_(Baseline зафиксировать до старта фазы 2 — простой counter в admin.)_
...
_Последнее обновление roadmap: июль 2026, часть 6 — рынок обмена едой (продажа за монеты) на странице /inventory.html._
