...
// ============================================================
// GAME CONFIG
// Единый источник правды для констант, которые ранее были
// продублированы между server.js (публичное лобби) и lib/room.js
// (приватные комнаты). Любое изменение баланса теперь нужно
// делать только здесь.
// ============================================================
...
// В server.js раньше бралось из DIFFICULTIES.normal.tickMs (115),
// в lib/room.js — отдельной константой TICK_MS (тоже 115).
// Значения совпадали, но это легко могло разойтись в будущем.
