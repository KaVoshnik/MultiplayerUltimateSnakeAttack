...
function moveNyx(boss, bosses, alive, GRID, avoidCells, deps) {
  ...
  // Приоритет: плохая еда рядом (поедание уже обработано в начале moveBosses,
  // здесь мы просто идём к ближайшей найденной падали)
  const badFood = findNearbyBadFood(deps.food, boss, boss.eatRadius || 30);
