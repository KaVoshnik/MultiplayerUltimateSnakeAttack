...
// tag_time-ветка только в лобби, shield-уведомление, текст
// причины смерти от яда). Эти расхождения сохраняются через
// опциональные колбэки/предикаты — не унифицируются.
// ============================================================
